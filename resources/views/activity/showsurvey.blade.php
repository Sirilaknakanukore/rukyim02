...
@section('content')
    <div class="container">
        ...
        <nav class="nav nav-pills nav-justified">
            <a style="font-family:'Pridi', serif; color: #F38644;  " class="nav-item nav-link" href="/activity">โพสต์ทั้งหมด</a>
            <a style="font-family:'Pridi', serif;background-color: #F38644;" class="nav-item nav-link active" href="/activity/survey">โพสต์ที่คุณติดตาม</a>
        </nav>
        <div class="row">
            @if(!empty($activities))
