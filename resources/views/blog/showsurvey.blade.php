...
@section('content')
    ...
    <div class="container">
        ...
        <nav class="nav nav-pills nav-justified " style="background-color: white;">
            <a style="font-family:'Pridi', serif; color: #F38644; " class="nav-item nav-link" href="/blog">โพสต์ทั้งหมด</a>
            <a style="font-family:'Pridi', serif; background-color: #F38644;" class="nav-item nav-link active" href="/blog/blogsurvey">โพสต์ที่แนะนำที่เหมาะกับคุณ</a>
        </nav>
        {{--nav--}}
        <div class="row">
            @if(!empty($blogs))
